...
async function verifyAuth(request: NextRequest) {
  ...
  try {
    ...
    console.log('🚀 ~ verifyAuth ~ privy:', privy);
    console.log('🚀 ~ verifyAuth ~ privy_token:', privy_token);
    console.log('🚀 ~ verifyAuth ~ privy_id_token:', privy_id_token);
    // Verify both tokens
    ...
    console.log('🚀 ~ verifyAuth ~ userId:', userId);
