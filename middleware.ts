...
class AuthMiddleware {
  ...
  public async authenticate(req: NextRequest): Promise<NextResponse> {
    ...
    connect-src 'self' https://app.apiswop.co https://swopme.app https://privy.swopme.app https://auth.privy.io wss://relay.walletconnect.com wss://relay.walletconnect.org wss://www.walletlink.org https://*.rpc.privy.systems https://*.g.alchemy.com https://*.quiknode.pro https://mainnet.helius-rpc.com https://aura-mainnet.metaplex.com https://*.coinranking.com https://*.cloudinary.com;
    worker-src 'self';
    manifest-src 'self';
  `
        .replace(/\s{2,}/g, ' ')
