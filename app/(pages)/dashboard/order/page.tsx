...
type TabType = "payments" | "sold" | "purchases" | "invoice";
...
const OrderManagement = () => {
  ...
  // Main tab state - changed to use the new tab system
  ...
  // Helper function to determine role based on active tab
  const getRoleFromTab = (tab: TabType): "seller" | "buyer" | "all" => {
    switch (tab) {
      case "sold":
        return "seller";
      case "purchases":
      ...
      case "invoice":
      default:
        return "seller"; // Default to seller for payments and invoice
    }
  };
  ...
  const StatusBadge = useCallback(
    ({ status, type }: { status: string; type: "payment" | "delivery" }) => {
      let colorClass = "";
  ...
  const currentOrders = (() => {
    switch (activeTab) {
      ...
      case "payments":
        // For payments, you might want to show all orders (both as seller and buyer)
        // For now, showing seller orders
        return data?.orders || [];
      case "invoice":
        // For invoice tab, you might want to filter or show specific data
        // For now, showing seller orders
        return data?.orders || [];
      default:
        return [];
    ...
    <div className="mx-auto max-w-full px-4 py-6">
      ...
      <div className="mb-8">
        <div className="flex gap-1">
          ...
          <TabButton tab="sold" label="Sold" />
          <TabButton tab="purchases" label="Purchases" />
          <TabButton tab="invoice" label="Invoice" />
        </div>
      </div>
      ...
      <div className="bg-white p-5 rounded-xl">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-1 items-center gap-2">
            <PrimaryButton className=" flex items-center gap-2 py-2">
              <span>Export Orders</span>
              <div className="bg-black rounded-full p-1 w-6 h-6 flex items-center justify-center">
                <HiOutlineDownload className="w-[14px] h-[14px] text-white" />
              </div>
            </PrimaryButton>
          ...
          <div className="flex-1 flex justify-center">
            <p className="capitalize bg-gray-100 px-10 font-medium py-2 rounded-full">
              {" "}
              {activeTab}
            </p>
          </div>
          ...
          <div className="flex flex-1 items-center gap-2 w-full md:w-auto ml-auto">
        ...
        {isLoading ? (
          ...
          <div className="bg-white p-12 rounded-xl shadow text-center">
            ...
            <Button className="bg-black text-white" onClick={resetFilters}>
              Clear Filters
            </Button>
          </div>
        ) : (
          <div className="space-y-6">
            <div className=" rounded-xl shadow-sm hover:shadow transition-all duration-200">
              <div className="p-0">
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-gray-50 hover:bg-gray-50">
                        ...
                        <TableHead className="font-semibold">
                          {activeTab === "purchases" ? "Seller" : "Customer"}
                        </TableHead>
                    ...
                    <TableBody>
                      {currentOrders.map((order) => (
                        <TableRow
                          ...
                          onClick={() =>
                            router.push(`/dashboard/order/${order.orderId}`)
                          }
                        >
                          ...
                          {(activeTab === "sold" ||
                            ...
                            <>
                              <TableCell>
                                <StatusBadge
                                  status={
                                    order.payout?.status || "Not Initiated"
                                  }
                                  type="payment"
                                />
                              </TableCell>
