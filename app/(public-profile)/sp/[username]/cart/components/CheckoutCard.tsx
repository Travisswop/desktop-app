  ...
  return (
    ...
    >
      ...
      <Section title="Order summary" divider={false}>
        ...
        >
          <SummaryRow
            label={`Subtotal (${cartItems.length} ${
      ...
      >
        ...
        {user && (
          <button
            ...
            style={{
              ...
              border: 0,
              cursor:
                !customerInfo.email || isWalletLoading
                  ? 'not-allowed'
                  : 'pointer',
              fontFamily: 'inherit',
              fontSize: 14,
              ...
              gap: 8,
              opacity:
                !customerInfo.email || isWalletLoading ? 0.55 : 1,
          ...
          >
            {isWalletLoading ? (
              ...
              <>
                <Wallet size={14} /> Pay with wallet
              </>
            )}
          </button>
        )}
        ...
        <button
          ...
          style={{
            ...
            padding: '12px 18px',
            borderRadius: 12,
            background: user ? '#fff' : ink,
            color: user ? ink : '#fff',
            border: user ? `1px solid ${hair}` : 0,
            cursor:
              !customerInfo.email || isCardLoading
                ? 'not-allowed'
                : 'pointer',
            fontFamily: 'inherit',
            fontSize: 14,
            ...
            justifyContent: 'center',
            gap: 8,
            opacity: !customerInfo.email || isCardLoading ? 0.55 : 1,
            transition: 'opacity .15s',
          }}
        >
          {isCardLoading ? (
        ...
        >
          Card payments processed securely by Stripe. Crypto settled
          on Solana.
        </p>
      </div>
    </div>
