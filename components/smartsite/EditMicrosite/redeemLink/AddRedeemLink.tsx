...
const AddRedeemLink = ({ handleRemoveIcon, handleToggleIcon }: any) => {
  ...
  return (
    <div className="relative flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2 xl:px-4 2xl:px-[10%]">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="w-full">
                ...
                <p className="font-medium mb-0.5 mt-1">Amount</p>
                <div>
                  <input
                    type="text"
                    name="amount"
            ...
            <div className="w-full flex items-center gap-4">
              <div className="w-full">
                <p className="font-medium mb-0.5">Link Name</p>
                <div>
                  <input
                    type="text"
                    name="link"
              ...
              <div className="w-full">
                <p className="font-medium mb-0.5">Mint Limit</p>
                <div>
                  <input
                    type="text"
                    name="mintLimit"
