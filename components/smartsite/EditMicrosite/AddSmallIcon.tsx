...
const AddSmallIcon = ({ onCloseModal }: any) => {
  ...
  return (
    <div className="relative flex flex-col gap-2 xl:gap-4">
      ...
      <form
        ...
        className="flex flex-col gap-2 mt-4 sm:px-10 2xl:px-[10%]"
      >
        <div className="flex items-center gap-3 w-full">
          <p className="font-medium min-w-36">Select Icon Type</p>
        ...
        <div className="flex items-center gap-3 w-full">
          <p className="font-medium min-w-36">Select Icon</p>
          <Dropdown className="w-max rounded-lg" placement="bottom-start">
            <DropdownTrigger>
              <div
        ...
        <div className="w-full">
          <p className="font-medium mb-1">{selectedIcon.inputText} :</p>
          ...
          <PrimaryButton className="w-full py-3 mt-4">
            {isLoading ? (
