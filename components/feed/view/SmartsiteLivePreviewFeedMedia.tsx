    ...
    <div className="">
      {mediaFiles.length > 0 && (
        <div className="mt-2 w-full flex justify-center">
              ...
              mediaFiles[0].type === "gif" ? (
                <div className="flex items-center justify-center h-full">
                  <Image
                    ...
                    className={`object-contain ${
                      isFromRepost ? "max-h-40" : "max-h-48"
                ...
                <video
                  ...
                  className={`w-full h-auto ${
                    isFromRepost ? "max-h-60" : "max-h-52"
                  } rounded-2xl`}
                />
              )}
            </div>
          ...
          {mediaFiles.length === 2 && (
            <div className="grid grid-cols-2 gap-1 border rounded-xl overflow-hidden relative h-36">
          ...
          {mediaFiles.length === 3 && (
            <div className="w-full grid grid-cols-3 gap-1 border rounded-xl overflow-hidden relative h-28">
              {mediaFiles.map((file: any, index: number) => (
                <div
                  key={index}
                  className="relative w-full h-full aspect-[4/3] overflow-hidden"
          ...
          {mediaFiles.length === 4 && (
            <div className="grid grid-cols-2 gap-1 border rounded-xl overflow-hidden relative h-40">
              {mediaFiles.map((file: any, index: number) => (
                <div
                  key={index}
                  className="relative w-full h-full aspect-[4/3] overflow-hidden"
...
export default SmartsiteLivePreviewFeedMedia;
