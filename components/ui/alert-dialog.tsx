...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // z-[100000]: the messages dashboard wraps itself in a z-[99999] fixed
      // layer, which painted OVER z-50 dialogs — the confirm popup was mounted
      // and focusable but invisible. Alert dialogs must sit above that layer.
