        ...
        <div className="min-h-[148px] overflow-hidden rounded-[14px] border border-white/[0.07] bg-black/20">
          {searchQuery.trim().length < 2 ? (
            ...
            <div className="dm-scroll max-h-[238px] overflow-y-auto p-1.5">
              {protectedAgentHint ? (
                <div className="mb-2 rounded-[12px] border border-[#3fe08f]/20 bg-[#10241b] px-3 py-3 text-left">
                  <div className="text-[12px] font-bold text-[#d7ffe8]">
                    {protectedAgentHint.label} opens from its desk
                  </div>
                  <div className="mt-1 text-[11px] leading-relaxed text-[#9fc8b0]">
                    Direct search may return ordinary contacts first. Use{' '}
                    {protectedAgentHint.groupName} for the supported agent
                    thread.
                  </div>
                  <button
                    type="button"
                    ...
                    className="dm-btn mt-3 inline-flex items-center gap-2 rounded-[11px] border border-[#3fe08f]/35 bg-[#153425] px-3.5 py-2 text-[12px] font-semibold text-[#d7ffe8] disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    {openingProtectedAgentId === protectedAgentHint.agentId ? (
