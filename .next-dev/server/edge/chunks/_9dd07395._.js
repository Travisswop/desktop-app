...
var __TURBOPACK__imported__module__$5b$project$5d2f$shims$2f$buffer$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/shims/buffer.js [middleware-edge] (ecmascript)");
    ...
    async set (cacheKey, pendingEntry) {
        ...
        try {
            ...
            for(let chunk; !(chunk = await reader.read()).done;){
                size += __TURBOPACK__imported__module__$5b$project$5d2f$shims$2f$buffer$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["Buffer"].from(chunk.value).byteLength;
            }
...
async function buildProxyRequest(testData, request) {
    ...
    return {
        ...
        request: {
            ...
            body: body ? __TURBOPACK__imported__module__$5b$project$5d2f$shims$2f$buffer$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["Buffer"].from(await request.arrayBuffer()).toString('base64') : null,
            cache,
            credentials,
            integrity,
            mode,
...
function buildResponse(proxyResponse) {
    ...
    return new Response(body ? __TURBOPACK__imported__module__$5b$project$5d2f$shims$2f$buffer$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["Buffer"].from(body, 'base64') : null, {
        status,
